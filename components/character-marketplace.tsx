...
export const characters: TbcCharacter[] = [
  // ── HORDE ──────────────────────────────────────────
  {
    ...
    notableItems: ["Hallowed Raiment (3/5)", "Revered rep healing gear"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Beast Lord Armor (4/5)", "Valanos Longbow"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Gladiators Greatsword", "Bold blue plate set"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Tidefury Raiment (3/5)", "Heroic dungeon weapons"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (4/5)", "Scryer rep offhand"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Frozen Shadoweave Set", "Heroic caster blues"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (2/5)", "Heroic caster offpieces"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    faction: "Horde", gearTier: "Pre-Raid Geared", professions: ["Leatherworking", "Skinning"], profSkills: [305, 320],
    notableItems: ["Earthwarden", "Wastewalker Armor (2/5)"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Tidefury Raiment (2/5)", "Cenarion Expedition rep gear"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Wastewalker Armor (2/5)", "Normal dungeon daggers"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (3/5)", "Sha'tar rep caster ring"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Moonglade Raiment (3/5)", "Cenarion rep healing"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Blue PvP honor gear (4/5)", "Honor caster staff"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Blue PvP honor set (3/5)", "Honor daggers"], server: "Nightslayer (PvP)",
  ...
  // ── ALLIANCE ───────────────────────────────────────
  {
    ...
    notableItems: ["Hallowed Raiment (4/5)", "Sha'tar rep healing"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Beast Lord Armor (3/5)", "Heroic dungeon bow"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Tidefury Raiment (3/5)", "Rep healing trinkets"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (4/5)", "KoT rep caster ring"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Wastewalker Armor (3/5)", "Heroic dungeon swords"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Hallowed Raiment (3/5)", "Aldor rep healing pieces"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (3/5)", "Normal dungeon wand"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Wastewalker Armor (2/5)", "Heroic tanking blues"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Beast Lord Armor (1/5)", "Valanos Longbow"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Tidefury Raiment (2/5)", "Heroic dungeon weapons"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (2/5)", "Normal dungeon caster"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Hallowed Raiment (2/5)", "Heroic healing blues"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Normal dungeon swords", "Assassination Armor (1/5)"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (2/5)", "Normal dungeon offpieces"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Bold Armor (2/5)", "Heroic dungeon axe"], server: "Nightslayer (PvP)",
  ...
  // ── PvP SPECIALISTS ────────────────────────────────
  {
    ...
    notableItems: ["Blue PvP honor set (4/5)", "Honor healing mace"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Blue PvP honor set (3/5)", "Honor healing shield"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Blue PvP honor set (4/5)", "Honor daggers"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Hallowed Raiment (2/5)", "Normal dungeon healing"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Bold Armor (2/5)", "Normal dungeon weapons"], server: "Dreamscythe (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (2/5)", "Normal dungeon caster"], server: "Thunderstrike (PvE)",
  ...
  },
  {
    ...
    notableItems: ["Beast Lord Armor (2/5)", "Heroic dungeon bow"], server: "Nightslayer (PvP)",
  ...
  },
  {
    ...
    notableItems: ["Mana-Etched Regalia (3/5)", "Heroic caster trinket"], server: "Nightslayer (PvP)",
