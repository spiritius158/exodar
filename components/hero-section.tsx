  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 text-center">
        ...
        {/* Discord + USP banner */}
        <div className="mx-auto mb-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-6">
          <div className="flex items-center gap-2 rounded-full border border-gold/20 bg-deep-black/60 px-4 py-2 backdrop-blur-sm">
            ...
            <span className="text-xs font-bold text-parchment/80">exodarmarket111</span>
          </div>
